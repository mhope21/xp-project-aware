        ...
        <PageWrapper loggedIn={loggedIn} setLoggedIn={setLoggedIn} setUser={setUser} user={user}>                   
          <ScrollToHash/>
           <Routes>
            ...
            <Route path="/contact" element={<Contact user={user} setLoggedIn={setLoggedIn} setUser={setUser} />} />
            <Route path="/kits" element={<Kits user={user} setUser={setUser} />} />
            <Route path="/kit_requests" element={<RequestKit user={user} setUser={setUser} setLoggedIn={setLoggedIn} />} />
