...
RSpec.describe RecurringAvailability, type: :model do
  describe 'validations' do
    ...
    it 'is invalid if end_date is in the past' do
      recurring_availability = RecurringAvailability.new(end_date: Time.zone.yesterday)
    ...
    it 'is valid if end_date is today or in the future' do
      recurring_availability = RecurringAvailability.new(end_date: Time.zone.today)
